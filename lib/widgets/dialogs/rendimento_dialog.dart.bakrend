                ...
                child: ListView.builder(
                    ...
                    itemBuilder: (ctx, i) {
                      ...
                      final isMatchTeam = highlightTeams != null &&
                          highlightTeams.contains(teamName);
                      final matchColor = isMatchTeam && getTeamColor != null
                      ...
                      return Container(
                        ...
                        decoration: BoxDecoration(
                            color: isMatchTeam && matchColor != null
                                ? matchColor.withOpacity(isDark ? 0.15 : 0.08)
                                : isTop3
                                    ...
                                    : isRetro
                                        ...
                                        : null,
                            border: Border(
                                left: BorderSide(width: 3, color: pColor),
                                bottom:
