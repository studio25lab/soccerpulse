...
class _MatchdayBarPainter extends CustomPainter {
  final bool isDark;
  final List<Map<String, dynamic>> matchdays;

  _MatchdayBarPainter({required this.isDark, required this.matchdays});
  ...
  @override
  bool shouldRepaint(covariant _MatchdayBarPainter old) => false;
}
