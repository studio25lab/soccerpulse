      ...
      child: ListView(
        ...
        children: [
          ...
          _statsSection(
            ...
            awayColor: awayColor,
            stats: [
              StatItem(S.of(context)!.tiriTotali, _homeShotsTotal, _awayShotsTotal),
              StatItem(S.of(context)!.tiriInPorta, _homeShotsOnTarget, _awayShotsOnTarget),
              StatItem(S.of(context)!.tiriFuori, _homeShotsTotal - _homeShotsOnTarget, _awayShotsTotal - _awayShotsOnTarget),
            ],
          ),
          const SizedBox(height: 14),
          ...
          _statsSection(
            ...
            awayColor: awayColor,
            stats: [
              StatItem(S.of(context)!.passaggiTotali, _homePassesTotal, _awayPassesTotal),
              StatItem(S.of(context)!.passaggiPrecisi, _homePassesCompleted, _awayPassesCompleted),
              StatItem(S.of(context)!.passaggiChiave, _homeKeyPasses, _awayKeyPasses),
              StatItem(S.of(context)!.crossRiusciti, _homeCrossOk, _awayCrossOk),
              StatItem(S.of(context)!.palleLunghe, _homeLongBallsOk, _awayLongBallsOk),
            ],
          ),
          const SizedBox(height: 14),
          ...
          _statsSection(
            ...
            awayColor: awayColor,
            stats: [
              StatItem(S.of(context)!.calciAngolo, _homeCorners, _awayCorners),
              StatItem(S.of(context)!.rimesseLaterali, _homeThrowIns, _awayThrowIns),
              StatItem(tr(context, 'Fuorigioco'), _homeOffsides, _awayOffsides),
            ],
          ),
          const SizedBox(height: 14),
          ...
          _statsSection(
            ...
            awayColor: awayColor,
            stats: [
              StatItem(S.of(context)!.contrastiTotali, _homeDefensiveStats.tacklesTotal, _awayDefensiveStats.tacklesTotal),
              StatItem(localizeShotData(context, 'Contrasti vinti'), _homeDefensiveStats.tacklesWon, _awayDefensiveStats.tacklesWon),
              StatItem(S.of(context)!.intercetti, _homeDefensiveStats.interceptions, _awayDefensiveStats.interceptions),
              StatItem(localizeShotData(context, 'Rinvii'), _homeDefensiveStats.rinvii, _awayDefensiveStats.rinvii),
            ],
          ),
          const SizedBox(height: 14),
          ...
          _statsSection(
            ...
            awayColor: awayColor,
            stats: [
              StatItem(S.of(context)!.falliLabel, _homeFouls, _awayFouls),
              StatItem(S.of(context)!.cartelliniGialli, _homeYellowCards, _awayYellowCards),
            ],
          ),
