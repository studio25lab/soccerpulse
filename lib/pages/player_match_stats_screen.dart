...
class _PlayerMatchStatsScreenState extends State<PlayerMatchStatsScreen>
            ...
            child: SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 16),
                  _buildMatchStats(isDark), // NUOVA SEZIONE
                  const SizedBox(height: 16),
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildStatBar('Tiri', 0.4, Colors.cyan),
          const SizedBox(height: 12),
          _buildStatBar('Passaggi', 0.6, Colors.orange),
          const SizedBox(height: 12),
          _buildStatBar('Dribbling', 0.5, Colors.green),
          const SizedBox(height: 12),
          _buildStatBar('Difesa', 0.2, Colors.grey),
        ],
      ),
    );
  }
  ...
  // NUOVA SEZIONE: Statistiche Match
        ...
        children: [
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 12),
              Expanded(
                child: Container(), // Spacer per allineamento
              ),
            ],
          ),
        ],
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          _buildStatRow('Assist previsti (xA)', '0.14', isDark),
          const SizedBox(height: 12),
          _buildStatRow('Passaggi chiave', '3', isDark, isInfo: true),
          const SizedBox(height: 12),
          _buildStatRow('Cross (prec.)', '0 (0)', isDark),
          const SizedBox(height: 12),
          _buildStatRow('Passaggi precisi', '65/69 (94%)', isDark),
          const SizedBox(height: 12),
          _buildStatRow(
              'Passaggi nella metà avversari...', '46/50 (92%)', isDark),
          const SizedBox(height: 12),
          _buildStatRow(
              'Passaggi nella propria metà (...', '19/19 (100%)', isDark),
          const SizedBox(height: 12),
          _buildStatRow('Lanci lunghi (prec.)', '4/4 (100%)', isDark),
          const SizedBox(height: 24),
          Center(
            child: ElevatedButton.icon(
              onPressed: () {
                _haptic.lightImpact();
                // Apri scheda completa giocatore
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => PlayerDetailScreen(
                      player: PlayerDetail(
                        ...
                        redCards: 0,
                        fouls: 18,
                        recentRatings: [7.2, 7.8, 6.9, 8.1, 7.5],
              ...
              label: const Text('Vedi Scheda Completa Giocatore'),
